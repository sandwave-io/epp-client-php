...
class ContactQueryTransferRequestTest extends TestCase
{
    public function test_contact_transfer_request(): void
    {
        ...
        $this->assertXmlStringEqualsXmlFile(__DIR__ . '/../data/requests/contact_transfer.xml', $xmlString);
    }
    ...
    public function test_contact_transfer_password_request(): void
    {
        ...
        $xmlString = $request->renderAndAppendChildren()->toString();
        $this->assertXmlStringEqualsXmlFile(__DIR__ . '/../data/requests/contact_transfer_password.xml', $xmlString);
    }
    ...
    public function test_contact_transfer_sidn_request(): void
    {
        ...
        $xmlString = $request->renderAndAppendChildren()->toString();
        $this->assertXmlStringEqualsXmlFile(__DIR__ . '/../data/requests/contact_transfer_sidn.xml', $xmlString);
    }
}
