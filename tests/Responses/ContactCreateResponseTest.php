...
class ContactCreateResponseTest extends TestCase
{
    public function test_response(): void
    {
        $response = new ContactCreateResponse(Document::fromString((string) file_get_contents(__DIR__ . '/../data/responses/contact_create.xml')));
