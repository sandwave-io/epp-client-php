...
class ContactUpdateResponseTest extends TestCase
{
    public function test_response(): void
    {
        $response = new ContactUpdateResponse(Document::fromString((string) file_get_contents(__DIR__ . '/../data/responses/contact_update.xml')));
