...
class DomainDeleteResponseTest extends TestCase
{
    public function test_response(): void
    {
        $response = new DomainDeleteResponse(Document::fromString((string) file_get_contents(__DIR__ . '/../data/responses/domain_delete.xml')));
