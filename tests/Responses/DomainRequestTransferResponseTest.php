...
class DomainRequestTransferResponseTest extends TestCase
{
    public function test_response(): void
    {
        $response = new DomainRequestTransferResponse(Document::fromString((string) file_get_contents(__DIR__ . '/../data/responses/domain_request_transfer.xml')));
