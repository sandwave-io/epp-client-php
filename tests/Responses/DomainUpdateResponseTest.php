...
class DomainUpdateResponseTest extends TestCase
{
    public function test_response(): void
    {
        $response = new DomainUpdateResponse(Document::fromString((string) file_get_contents(__DIR__ . '/../data/responses/domain_update.xml')));
