...
class KeysystemsServiceUpdateTest extends TestCase
{
    public function test_fields(): void
    {
        ...
        $driver->expectRequest(__DIR__ . '/../../../data/requests/contact_update_fields_keysystems.xml', __DIR__ . '/../../../data/responses/contact_update.xml');
    ...
    public function test_add_status(): void
    {
        ...
        $driver->expectRequest(__DIR__ . '/../../../data/requests/login_keysystems.xml', __DIR__ . '/../../../data/responses/login.xml');
        $driver->expectRequest(__DIR__ . '/../../../data/requests/contact_update_add_status_keysystems.xml', __DIR__ . '/../../../data/responses/contact_update.xml');
        $driver->expectRequest(__DIR__ . '/../../../data/requests/logout_keysystems.xml', __DIR__ . '/../../../data/responses/logout.xml');
    ...
    public function test_rem_status(): void
    {
        ...
        $driver->expectRequest(__DIR__ . '/../../../data/requests/login_keysystems.xml', __DIR__ . '/../../../data/responses/login.xml');
        $driver->expectRequest(__DIR__ . '/../../../data/requests/contact_update_rem_status_keysystems.xml', __DIR__ . '/../../../data/responses/contact_update.xml');
        $driver->expectRequest(__DIR__ . '/../../../data/requests/logout_keysystems.xml', __DIR__ . '/../../../data/responses/logout.xml');
