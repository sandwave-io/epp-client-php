...
class KeysystemsServiceUpdateTest extends TestCase
{
    public function test_add_nameserver(): void
    {
        ...
        $driver->expectRequest(__DIR__ . '/../../../data/requests/domain_update_add_nameserver_keysystems.xml', __DIR__ . '/../../../data/responses/domain_update.xml');
    ...
    public function test_remove_nameserver(): void
    {
        ...
        $driver->expectRequest(__DIR__ . '/../../../data/requests/login_keysystems.xml', __DIR__ . '/../../../data/responses/login.xml');
        $driver->expectRequest(__DIR__ . '/../../../data/requests/domain_update_remove_nameserver_keysystems.xml', __DIR__ . '/../../../data/responses/domain_update.xml');
        $driver->expectRequest(__DIR__ . '/../../../data/requests/logout_keysystems.xml', __DIR__ . '/../../../data/responses/logout.xml');
    ...
    public function test_add_contact(): void
    {
        ...
        $driver->expectRequest(__DIR__ . '/../../../data/requests/login_keysystems.xml', __DIR__ . '/../../../data/responses/login.xml');
        $driver->expectRequest(__DIR__ . '/../../../data/requests/domain_update_add_contact_keysystems.xml', __DIR__ . '/../../../data/responses/domain_update.xml');
        $driver->expectRequest(__DIR__ . '/../../../data/requests/logout_keysystems.xml', __DIR__ . '/../../../data/responses/logout.xml');
    ...
    public function test_remove_contact(): void
    {
        ...
        $driver->expectRequest(__DIR__ . '/../../../data/requests/login_keysystems.xml', __DIR__ . '/../../../data/responses/login.xml');
        $driver->expectRequest(__DIR__ . '/../../../data/requests/domain_update_remove_contact_keysystems.xml', __DIR__ . '/../../../data/responses/domain_update.xml');
        $driver->expectRequest(__DIR__ . '/../../../data/requests/logout_keysystems.xml', __DIR__ . '/../../../data/responses/logout.xml');
    ...
    public function test_add_status(): void
    {
        ...
        $driver->expectRequest(__DIR__ . '/../../../data/requests/login_keysystems.xml', __DIR__ . '/../../../data/responses/login.xml');
        $driver->expectRequest(__DIR__ . '/../../../data/requests/domain_update_add_status_keysystems.xml', __DIR__ . '/../../../data/responses/domain_update.xml');
        $driver->expectRequest(__DIR__ . '/../../../data/requests/logout_keysystems.xml', __DIR__ . '/../../../data/responses/logout.xml');
    ...
    public function test_remove_status(): void
    {
        ...
        $driver->expectRequest(__DIR__ . '/../../../data/requests/login_keysystems.xml', __DIR__ . '/../../../data/responses/login.xml');
        $driver->expectRequest(__DIR__ . '/../../../data/requests/domain_update_remove_status_keysystems.xml', __DIR__ . '/../../../data/responses/domain_update.xml');
        $driver->expectRequest(__DIR__ . '/../../../data/requests/logout_keysystems.xml', __DIR__ . '/../../../data/responses/logout.xml');
    ...
    public function test_change_registrant(): void
    {
        ...
        $driver->expectRequest(__DIR__ . '/../../../data/requests/login_keysystems.xml', __DIR__ . '/../../../data/responses/login.xml');
        $driver->expectRequest(__DIR__ . '/../../../data/requests/domain_update_change_registrant_keysystems.xml', __DIR__ . '/../../../data/responses/domain_update.xml');
        $driver->expectRequest(__DIR__ . '/../../../data/requests/logout_keysystems.xml', __DIR__ . '/../../../data/responses/logout.xml');
    ...
    public function test_change_password(): void
    {
        ...
        $driver->expectRequest(__DIR__ . '/../../../data/requests/login_keysystems.xml', __DIR__ . '/../../../data/responses/login.xml');
        $driver->expectRequest(__DIR__ . '/../../../data/requests/domain_update_change_password_keysystems.xml', __DIR__ . '/../../../data/responses/domain_update.xml');
        $driver->expectRequest(__DIR__ . '/../../../data/requests/logout_keysystems.xml', __DIR__ . '/../../../data/responses/logout.xml');
