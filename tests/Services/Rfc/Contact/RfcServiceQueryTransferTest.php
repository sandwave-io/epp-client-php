...
class RfcServiceQueryTransferTest extends TestCase
{
    public function test_info(): void
    {
        ...
        $driver->expectRequest(__DIR__ . '/../../../data/requests/contact_transfer.xml', __DIR__ . '/../../../data/responses/contact_transfer.xml');
