...
class SidnServiceTransferTest extends TestCase
{
    public function test_info(): void
    {
        ...
        $driver->expectRequest(__DIR__ . '/../../../data/requests/domain_transfer_sidn.xml', __DIR__ . '/../../../data/responses/domain_transfer.xml');
